...
* Firebase , [Cloud Storage](https://firebase.google.com/docs/storage/web/start) and [Cloud Firestore](https://github.com/thanhtutzaw/todolist3/blob/main/README.md#nosql-document-database)
...
:ballot_box_with_check:	Signup with email\
:ballot_box_with_check:	Sort Posts by Date\
:ballot_box_with_check:	Fetch All Users Posts - SSR\
:ballot_box_with_check:	Update Profile (userName,bio)\
:ballot_box_with_check:	Select and Delete Multiple Posts\
:ballot_box_with_check:	Upload Medias , Preview Layout , Image Zoom
